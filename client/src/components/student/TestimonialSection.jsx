...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Discover inspiring stories from our learners as they share their growth, achievements,<br/>
      and how our platform helped shape their success.</p>
