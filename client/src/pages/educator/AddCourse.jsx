...
const AddCourse = () => {
  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8">
        ...
        <div >
          ...
          {showPopUp && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="relative bg-white text-gray-700 p-6 rounded-lg w-full max-w-md shadow-lg">
                {/* Title */}
                ...
                <button
                  onClick={addLecture}
                  type="button"
                  className="w-full bg-blue-500 hover:bg-blue-600 transition text-white px-4 py-2 rounded-md"
                >
                  Add
                </button>
