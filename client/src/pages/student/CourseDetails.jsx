        ...
        <div className='p-5'>
          ...
          <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
            <div className='flex items-center gap-1'>
              <img src={assets.star} alt="star_icon" className='' />
              <p>{calculateRating(courseData)}</p>
            </div>
            <div className='h-4 w-px bg-gray-500/40'></div>
            <div className='flex items-center gap-1'>
              <img src={assets.time_clock_icon} alt="time_clock" className='' />
              <p>{calculateCourseDuration(courseData)}</p>
            </div>
            <div className='h-4 w-px bg-gray-500/40'></div>
            <div className='flex items-center gap-1'>
              <img src={assets.lesson_icon} alt="time_clock" className='' />
              <p>{(calculateNoOfLectures(courseData))} lessons</p>
            </div>
          </div>
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled?'Continue to course':'Enrolled now'}</button>
          <div className='pt-6'>
            <p className='md:text-xl text-lg font-medium text-gray-800'>What's the course about?</p>
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              <li>Unlimited access with future updates included.</li>
              <li>Hands-on, practical projects to build real skills.</li>
              <li>Downloadable assets and complete source files.</li>
